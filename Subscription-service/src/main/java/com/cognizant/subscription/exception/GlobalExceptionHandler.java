...
import com.cognizant.subscription.model.ExceptionResponse;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> microServiceUnavailableExceptions(MicroServiceNotAvailable microserviceNotAvailable ) {
		return new ResponseEntity<>(
				new ExceptionResponse(microserviceNotAvailable.getMessage(), LocalDateTime.now(), HttpStatus.NOT_FOUND),
				HttpStatus.NOT_FOUND);
	}
	/**
	 * @param invalidTokenException
	...
	public ResponseEntity<ExceptionResponse> microServiceUnavailableException(MicroServiceNotAvailable microserviceNotAvailable ) {
		return new ResponseEntity<>(
				new ExceptionResponse(microserviceNotAvailable.getMessage(), LocalDateTime.now(), HttpStatus.NOT_FOUND),
				HttpStatus.NOT_FOUND);
	}
